...
extern	int		Graphics_D3D9_ReleaseObjectAll( bool onlyUnmanaged = false ) ;						// すべての Direct3D9 系オブジェクトを解放する
extern	int		Graphics_D3D9_CreateObjectAll( bool onlyUnmanaged = false ) ;							// すべての Direct3D9 系オブジェクトを作成する
